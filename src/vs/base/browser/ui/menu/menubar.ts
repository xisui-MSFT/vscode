...
import { menuBarMore } from 'vs/base/browser/ui/codiconLabel/codicons';
...
export class MenuBar extends Disposable {
	...
	createOverflowMenu(): void {
		...
		const titleElement = $('div.menubar-menu-title.toolbar-toggle-more' + menuBarMore, { 'role': 'none', 'aria-hidden': true });
